...
| Jupiter–Ceres separation | **3.33 AU** at MET 0 → **≈ 2.35 AU** at MET ~305 (Epilogue) | Lane length. Close Season. |
...
| Callisto ↔ *Nightjar* at Mark 9 region (Lane inner quarter) | ~2.6 AU | Path length of the 73-day outbound run *at arrival* (the Lane is ≈ 3.06 AU at MET 83), not the departure-day separation. 73 d and 247 km/s at 4 mgee are consistent with this figure only. |
...
| Jupiter ↔ Ceres (Epilogue, MET ~305) | 19.5 min | 39 min |
...
- The Lane profile costs a freighter 242 km/s. With a 1,000 km/s exhaust, that is a 21.5% propellant fraction (rocket equation, `m₀/m₁ = e^(Δv/vₑ)`). **The Lane-standard fuel fraction is 0.215 of declared departure mass** at the Close-Season geometry (3.33 AU). In general the Bureau certifies fuel against the profile plotted for each departure: **f_lane(d) = 1 − e^(−2√(d·a_nom)/vₑ)**, from 0.186 at 2.4 AU to 0.313 at 8 AU, and *required fuel* = f_lane × declared mass is a column in every certification. This ratio is the spine of Acts II and IX.
...
| **Inferred mass** | `m = F/a`, with F from drive model + plume power | **±2%** (1 SD of the honest residual, as a fraction of declared mass) |

Example: a Sulcus-class hull, Mk 3 drive, 3.00 mgee profile, nominal 20,000 t. Thrust 588 kN, jet power ≈ 0.29 TW. If the plume reads 0.29 TW but the acceleration is 2.78 mgee, the inferred mass is 21,600 t — **8% heavier than declared**, a 4-SD residual against the honest 2% spread. This is the Act II mechanism.
...
- **Lighting the torch takes four minutes from Standby (torch pre-heated) and twenty-two minutes from Quiet or Watch (reactor scrammed).** A cold ship is a ballistic object, and its path is exactly predictable; her cold thrusters (≤ 200 N) move her less than twelve metres in ten minutes. This is the sentence that kills Dagny Oyelaran.
...
| Delta-v, full tanks | **518 km/s** (`900 × ln(3200/1800)`) |
...
Why the round comes: you order the lidar ping to identify the hulls at Kettle. You computed the odds in Act IV and refined them in Act VIII: a picket is likely somewhere; a 40-second dwell gives an unambiguous ID and roughly a thirty-percent chance the picket is positioned to respond before you can light the torch. You take it. That is the second decision. *Patience*, cold at 2,100 km off your quarter, has orders to fire only on active illumination. The slug takes ten minutes to arrive. Solberg reads the RF spike; Ebele plots the cone; the Chief cannot light the torch in under twenty-two minutes from Watch and the slug does not care. Ferrante is at the mast root when the blister goes. He tells you eight seconds.
...
| **V** | 5 · Sampling distributions | Cutter reports (*Asgard* 3/410, *Tindr* 1/380); the Board's baseline (Mars–Belt corridor 1.1%) vs. your own 2176 baseline (0.5%); the 19 heavy hulls' marks | Sampling distribution of p̂ and x̄; CLT machine; simulate patrol windows under each baseline; z for a sample mean (mean mark of the 19 = 9.3 vs. 6.5 under "anywhere" — continuous uniform on [1, 12], SE 0.73) | Cutter disagreement is expected variation — no conspiracy needed to explain *that*; the Lane's overall rate looks unremarkable under the Board's baseline and extreme under yours; the 19's mark clustering is 3.8 SE out (and their mean Mark-9 delay 4.6 SE out) | Formal test; who the 19 belong to | Which baseline to adopt in your report; go to Ceres for the claims register (fuel + evidence) or hold station |
...
| **VIII** | 8 · Chi-square | Oyelaran's lidar returns (14 hulls identified at Kettle: 12 of the 19, plus *Harpagia Sulcus* and *Marius Regio*, the two diversions witnessed during the story); declared cargo categories of the 31 vs. the Lane mix; loss × beneficiary across 2,612 transits; cause code by corridor (Lane vs Mars–Belt); classification × investigating office; examiner × lost/not lost among Perrine departures | **χ² goodness-of-fit** (lost hulls over-declare "volatiles"); **χ² independence** (loss is not independent of beneficiary; the driving cell is *Perrine, lost*); **χ² homogeneity** (the Lane's cause-code mix differs from the Mars–Belt corridor's); supplementary tables: classification depends on office; Dacre's stamp over-represented | The lost hulls are at Kettle; the classifications were manufactured at Uruk; Dacre's stamp; the four "piracy" losses are the only non-Perrine hulls Uruk classified — the cover losses | Premeditation at departure (the hulls could have been hijacked en route) | Ping duration; send the IDs now or hold for the regression |
| **IX** | 9 · Inference for slopes | Brandt's Bureau fuel certifications for all 900 Perrine departures (19 diverted flagged): fuel loaded vs. declared mass; for each departure date, the Δv from Mark 9.4 to rest at Kettle (24–38 km/s, from the nav software) | **CI for slope**: for the 19, fuel loaded on required Lane fuel (f_lane × declared), slope ≈ 1.17, interval excludes the physical 1.00 (the 881 honest Perrine hulls bracket it); **t-test for slope**: excess fuel per true tonne on Kettle Δv, H₀: β = 0 under every innocent story; slope ≈ 0.00076 per km/s (t ≈ 4.7), bracketing the rocket equation's marginal fuel per km/s at the thrust-limited operating point (≈ 0.00079); conditions (LINE), residuals | The fuel to divert was loaded at Uruk High and certified, and it was the fuel to reach Kettle *on the day each hull left* — **intent at the Compact end** | — (Book One's proof is complete) | How to deliver: Board only / Inspectorate + Board / broadcast. The confrontation at Halden Reach. |
...
**Turn.** The summary page's mean (Mark 6.5, "spread along the Lane" — computed over all 2,200 records of every severity, not over the 31 losses, whose mean is about 8.5) is the Board's finding. The records are the Act I dataset. To know whether the summary is honest you need to see the shape of the thing, not its centre.
...
**Beats.**
1. MET 12 — Ebele's first display: a histogram of *mark* across all 2,200 records, binned in threes, showing nothing. You have him filter to the 31 losses and bin by mark. The Mark 9–10 pile appears. Ferrier: "Show me what thirty-one random accidents look like on that axis."
...
6. MET 30 — Solberg sends it. Three minutes out, three back; Callisto is still close. The Board's reply comes in four hours: *noted; continue within the assigned profile.*
...
2. MET 36 — The residual plot. Nineteen points sit above the band at +6 to +13% (two tiers, as Act VII will explain). All nineteen are lost hulls. The other twelve lost hulls are in the band. Ferrier: "Tell me the nineteen aren't just big ships." They are not; residual against declared mass shows no fan.
...
5. MET 76 — Cross-tab from the survey and the Incident File: who classified what. All four *piracy* classifications, and all nineteen Perrine *unknown*s, came from the Uruk office; Ceres classified its eight as accidents or unknown.
6. MET 80 — Three days from torch-off, braking since turnover at MET 46. You file the survey report. The Board acknowledges in two words.
...
**Beats.**
1. MET 110 — Why the reports disagree. Ebele builds a sampling-distribution machine on the Register: draw 400-transit windows at random, count losses. Three and zero are both ordinary. The Board's preferred statistic — the *lower* of the two cutters' observed rates — is biased low by construction, and Ebele shows it by stacking the statistic. Ferrier: "So the cutters aren't lying. Good. Now show me what the Board is doing with them."
2. MET 112 — The normal, revisited. Mark-9 *delay* against the nominal 3.00-mgee plot, across the Lane's honest transits, is close to normal (mean 0, SD 2.7 days — days, not hours, because hulls file their own profile inside the Lane's 2.7–3.3 mgee band and old drives file slow). You find the cutoff above which only 1% of honest transits fall: 6.2 days. The nineteen average 2.8 days late; one of them is above the cutoff. Individually they are unremarkable — about one honest hull in seven is that late — and Ferrier makes you say so first, so nobody says it for you. Solberg notes the Register has their Mark 9 check-ins to the second, and a profile-deviation advisory on each.
3. MET 114 — The Machine. Ebele runs the CLT on the Register's transit times with n = 19: what a mean of nineteen honest transits looks like, and where the nineteen sit (z ≈ 3.8 on the mark axis; z ≈ 4.6 on the delay axis, SE 2.7/√19 = 0.62 days). Oyelaran watches the sampling distribution form and says, unprompted, that she had thought "normal" was a property of things and not of averages.
4. MET 116 — Proportions in the noise. Two-population sampler: what the *difference* in loss proportions between two owner classes looks like under a common rate. This is the null model for the accusation. You do not run the test yet. Ferrier insists on seeing the noise before the signal, on the record.
5. MET 117 — The baseline. The Board's 1.1% is the Mars–Belt corridor, the roughest in the system. Your own 2176 patrol report — you dig it out of the ship's archive; Ebele has never seen it — put the Lane at 0.5% (13 in 2,580). Under 1.1%, 31 in 2,612 is unremarkable; under 0.5%, it is five standard errors out. The rate argument depends entirely on which null the Board is allowed to choose. You write that sentence and stop, because the composition argument does not.
6. MET 118 — Decision: Ceres — 0.4 AU, fifteen days at fifteen milligee and 188 km/s; she will arrive on fumes. Fuel, the claims register, the adjuster. Ferrier logs that entering Ceres approach control means transponder-on, which means everyone on the Lane, including Kettle, will know where *Nightjar* is. You go. The Chief starts the torch.
...
### Act VI — *Accusation* (MET 133–142) · Unit 6

**Opening.** MET 133. Ceres approach control, transponder on, 40 plumes in the sky and half of them within a light-second. *Nightjar* takes fuel at the Compact consular berth. Captain Marsh, her hull waiting nine days on a berth, comes aboard with a bottle and a grievance on the first night and is in and out of the wardroom until she sails. **Adjuster Halide Renn**, Tharsis Mutual, asks for a meeting in the consulate and says, in a Martian accent that makes Ferrier's jaw set, that her syndicate has paid Perrine Holdings 2.1 billion over six years and would like to know why the Compact navy is only now curious.
...
**Beats.**
1. MET 133 — Capture. Before any number goes up the chain, you make Ebele show you what "95% confident" commits you to: a hundred intervals from a hundred years of Lane traffic, and the ones that miss.
2. MET 134 — Margin. The Lane's loss rate, 31 in 2,612, with an honest interval: it excludes 0.5%. It does not exclude 1.1%. You write both sentences. Ferrier: "Then that isn't the claim. Make the claim the data can carry."
3. MET 135 — The register arrives (from Okafor-Reyes, through channels; Renn's copy sits unopened in the consulate safe, or opened — the learner's call). Beneficiary of each lost hull's policy. Nineteen: Perrine Holdings. Twelve: eleven owners. Ebele builds the two-way table and says nothing for a while.
4. MET 136 — The hypothesis. H₀: Perrine hulls are lost at the same rate as everyone else's. Hₐ: at a higher rate. One-sided, chosen *before* the number, and you have Ebele write down why. Conditions, with the pooled proportion: 900 × 0.0119 = 10.7 — the large-counts condition passes by seven-tenths of a hull, and Ferrier makes a note that a hostile reviewer will see that too.
5. MET 137 — The p-value and the sentence. z ≈ 3.2, p ≈ 0.0008. Ebele's first draft says the result "proves" Perrine hulls are being targeted. You strike *proves* and *targeted*. What the data say: convincing evidence that hulls insured to Perrine Holdings are lost at a higher rate than other hulls on the Lane. What it does not say: by whom, or why.
6. MET 138 — Errors and power. Ferrante, off the record, on the cost of each error: Type I is your career and a Service scandal on a Martian adjuster's desk; Type II is the next nineteen hulls. You choose α = 0.01 and write down why. The module tells the learner, in the Chief's voice, that some errors are paid in hulls and some in people, and that they are about to find out which.
7. MET 140 — The accusation. A four-step brief — state, plan, do, conclude — signed with your name and hull number, to the Board via Lane Operations, with a copy to the Flag Secretary. Solberg counts it out: 24 minutes — Ceres to Valhalla is 2.9 AU now. The reply, MET 141/02:10, is the first in the book signed *Ashby-Hale* personally: *Anselm. Received. The Board will convene. Proceed to rendezvous with CSV Halden Reach at the attached coordinates for sink refit and resupply; Captain Ostrow will brief you on the Board's transit-time analysis, which addresses your concern.* Solberg: the reply's timestamp is four minutes after your transmission arrived at Valhalla.
8. MET 142 — Marsh, sailing: her brother's ship departed Uruk High two days behind *Nicholson Regio* in the spring of 2182. Both were classified at Uruk. Only one of them was ever called *piracy*. She wants to know what you're going to do. You tell her you have reported it. She looks at you the way Ferrier does.
...
7. MET 165 — Which procedure. The inference brief: every finding, its procedure, its conditions, its limits, bootstrapped where the conditions were thin. Sent to the Board via *Halden Reach*'s relay (Ostrow reads it first; you know he will) with a copy to the Flag Secretary. Then the decision. *Marius Regio*'s off-profile vector from Act IV, propagated forward with Ebele's nav work, intersects the orbit of a six-kilometre body at 3.41 AU that the chart lists as a prospector's abandoned claim. Kettle. Fourteen days' coast from *Halden Reach* at thirty kilometres a second, the last two of them cold, with a sink nine hours shorter against design than it was.
...
**Opening.** MET 180/22:00. Fourteen days' ballistic coast at thirty kilometres a second on a line that passes Kettle and goes on to Hygiea Hold, which is where the log says she is going; three purges on the way, the last ending MET 179/12, 4.5 million km out — beyond any civilian-grade sensor, and Kettle's sensors are civilian-grade (PROVIDENT's hulls carry Adlinda weapons, not Valhalla optics). Since then: Watch, parasol out, skin at 120 K, the Eyes folded and the refit array — which Oyelaran does not trust — doing the watch. The survey camera has resolved Kettle since 20:30, a million kilometres back: eleven warm shapes docked, three standing off. It shows hulls. It cannot show names. Closest approach 38,000 km at 181/06:00; the lidar's window inside 40,000 km is fourteen minutes.

**Pressure.** Watch on the post-refit sink (59 h design; the Chief works to 55): 63% now, 76% at closest approach; the torch is twenty-two minutes away from Watch. A picket is likely: Ebele's tree — a wrecker at Kettle at all, and on picket within slug range of the approach quarter — puts the probability that a cold tug can respond inside the time it takes to light the torch at 0.3. The lidar is the only instrument that will give hull IDs, and the lidar is a lamp in a dark room.

**Beats.**
1. MET 180/22:00 — Are my results unexpected. While you wait for the geometry, Ebele runs the Register's declared cargo categories for the 31 lost hulls against the Lane's mix (He-3/deuterium 38%, volatiles 21%, metals 17%, manufactured and other 24%): expected counts, all above five, statistic large (≈ 41), df 3. Lost hulls over-declare *volatiles* by a factor of three. Ammonia is the cheapest heavy thing you can write on a manifest.
...
3. MET 181/06:01 — Fourteen returns. *Marius Regio*. *Nicholson Regio*. *Perrine Regio*. *Tiamat Sulcus*. Ten more. Hulls the Register calls *unknown, presumed lost*, docked to a rock, with their names still stencilled on them. Solberg: "RF transient, bearing two-two-zero, two thousand one hundred kilometres. Cold source." Ebele plots the cone. Sandoval: "Twenty-two minutes to light. We're on Watch." Ferrier: "Slug's inside ten."
4. MET 181/06:12 — The frame rings once. The blister is gone. Ferrante is at the mast root. Eight seconds. The lidar buffer is intact. The torch lights at 06:24 and you run at 0.3 g for eleven hours with the wings out, a beacon to everyone in the Belt, and *Patience* does not follow because a tug cannot.
...
**Module coverage (act-8-01…04).** 8-01 beat 1 (setup); 8-02 beat 1 (conclusion: contributions from *volatiles*, over, and *He-3/deuterium*, under); 8-03 beat 6 (independence vs homogeneity, correctly framed); 8-04 beat 6 (carrying out; examiner table; procedure selection). The loss falls between 8-02 and 8-03, as the curriculum map requires.
...
2. MET 208 — Interval for the slope. Fuel loaded on the fuel the plotted profile required (f_lane × declared mass, the Bureau's own column), the nineteen. Physics fixes the slope at one tonne per tonne. The nineteen's fitted slope is ≈ 1.17; the 95% interval excludes 1. Residuals fine, no fan, no curve; nineteen points, df 17. They were fuelled for mass they did not declare — and ballast tanks scale with hull, so the extra is a slope, not an intercept. Same regression on the 881 surviving Perrine hulls: interval brackets 1.00. Honest ships, honest fuel.
3. MET 213 — Testing the slope: the variable that cannot be innocent. For each of the nineteen departure dates, the nav software gives the Δv a hull at Mark 9.4 would need to arrive at rest at Kettle instead of Ceres — it varies from 24 to 38 km/s over six years as the Lane, Ceres and Kettle move. Under any innocent story — clerical error, petty under-declaration, rogue crews — that number has *nothing to do with* how much fuel a hull loaded at Uruk High: β = 0. You regress excess fuel per *true* tonne (fuel ÷ the whole-phase inferred mass Ebele reprocessed from the relay archive, minus that month's f_lane) on Kettle Δv. Slope ≈ 0.00076 per km/s, SE ≈ 0.00016, t ≈ 4.7, p < 0.001. Ebele's first guess for the physical value is 1/vₑ = 0.0010; Sandoval: "At zero delta-v, Ensign. These hulls are at two-thirty by Mark nine." The rocket equation's marginal fuel per km/s of extra braking at the thrust-limited Lane burn (≈ 234 km/s at 1,000 km/s exhaust) is e^(−0.234)/1000 ≈ 0.00079 — and the interval brackets it. **The excess fuel on each hull is the fuel to reach Kettle on the day it left.** Someone computed that number at Uruk High, nineteen times, before the stamp went on.
...
| act-1-02 Cause Codes | Act I beat 1; the Board's bar chart of classifications over all 2,200 records | Ebele restores the denominator (losses only): *unknown* is 22 of 31 (19 of them Uruk's), *accident* 5, *piracy* 4 |
...
| act-1-05 Five Numbers | Act I beat 2–3; boxplot of plume-power ratio — the 1.5 × IQR fence flags the hot contact; the time-to-silence boxplot is the counter-example (a box hides two piles) | Hull id requested — first thread |
...
35. **Lane-standard fuel fraction / f_lane** — the propellant fraction the plotted profile needs for a departure's Lane length, f_lane(d) = 1 − e^(−2√(d·a)/vₑ): 0.215 in the Close Season at 3.33 AU, 0.186–0.313 across the cycle. *Required fuel* = f_lane × declared mass; fuel loaded against required fuel is the physical slope of one.
...
4. **The act-9-03 variable** — chosen: **excess fuel fraction** (fuel loaded ÷ declared mass − 0.215) regressed on the **Δv required to reach Kettle from Mark 9.4 on each hull's departure date** (24–38 km/s across six years as the geometry moves; the nav software supplies it). Under every innocent story the population slope is zero. Response = fuel per *true* tonne (whole-phase inferred mass) minus the departure month's f_lane, so the hidden-mass fraction cancels; observed slope ≈ 0.00076 per km/s against the rocket-equation prediction at the thrust-limited operating point, e^(−234/1000)/1000 ≈ 0.00079 (see beat-sheet §5 decision 11 and §8, B2). Conditions: nineteen independent departures, linear by construction, residuals homoscedastic; this is a random sample only in the sense that the 19 are all diverted hulls — the module should state the scope of inference as "these nineteen departures" and let 9-04 handle what that limits. act-9-02's interval uses fuel loaded on required Lane fuel, slope ≈ 1.17 vs the physical 1.00; the 881 honest Perrine hulls bracket 0.215 as the control regression.
...
7. **Two small requests back.**
   ...
   - *Showrunner's resolution (see `docs/beat-sheet.md` §5, decisions 1–2):* the examiner table is the "conditions fail — simulate the null" lesson (permutation on random assignment of 19 losses among 900 departures), not a collapse; act-6-08 keeps 900/1,712 and the narrow 10.7 is the beat.
