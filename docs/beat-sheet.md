...
15. *The pointless action as emotion.* "She checks a gauge **that does not need checking**." The "does X that does not need doing" shape announces its own symbolism — a stage direction with a footnote saying *she is stalling*. Give the character a real action with a purpose that reveals the same thing (Sandoval scrolls the trace back three hours before answering, because she does not commit to a number without looking). Same family: studying one's hands, a long breath, holding a look a beat too long.
16. *The voice rule performed as a tic.* The voice notes below describe how a person **thinks**, not a catchphrase to repeat. Sandoval's "numbers carry their uncertainty" became *"The loads wander. Sensor processing wanders. The loops wander with the sun angle. Sixteen people wander… Load wanders, hours wander."* — one verb five times in four sentences of identical syntax. Nobody speaks in anaphora. In any speech over two sentences, check for: a word repeated for rhythm, every sentence sharing a structure, a rhetorical point standing in for an answer, and a specialist philosophising where they would give a figure. Speech is ragged — fragments, one concrete number, an interruption, a change of subject.
17. *The corrective reframe: "it's not X, it's Y."* A negation followed by the real answer, used as the default way to make a point — "The code isn't a measurement, it's a finding"; "That is not a failure of the method; it is the method telling you the truth." A rhetorical move standing in for a sentence, and a drone at scale (**39 instances across Acts II–VI** when this was written). Say the positive thing. Same family: "not because A, but because B"; "The problem is not A. The problem is B". **Narrow exception:** where the negation *is* the misconception being taught and the reader holds it (density vs probability, mutually exclusive vs independent) — and even then state the truth first, once per module.
18. *The epigram, and the character who reads the protagonist's soul.* *"You look like a man who has been handed a ship by a friend and is waiting to find out what it costs."* A supporting character delivering a polished aphorism about Rook's inner state — nobody talks like this, and it outsources the banned move of telling the reader what the CO feels. A doctor takes a pulse and says a number. That same line went on to *"That is not a medical finding. It is a base rate"*: a character punning on the module's concept, i.e. the idea name-dropped as a joke rather than taught. **A crew member's statistical habit shows up as how they reason about their own job** — Ferrante: *"I have cleared nine officers into a first command. Seven slept badly for a fortnight and then stopped, and two did not, and I could not have told you in advance which two."* Never as them saying the term.
19. *Narration that admits it is a lesson.* "You give the table to Ebele, **because he is the one who has to learn it**." The fiction never acknowledges its pedagogical purpose. Ebele is an officer doing a job, not a proxy for the learner.
