...
16. **Narration that admits it is a lesson.** "You give the table to Ebele, *because he is the one who has to learn it*." The fiction must never acknowledge its own pedagogical purpose. Ebele is an officer doing a job, not a stand-in for the learner.
